...
function myFunction(citySearch) {
    ...
    fetch(
        ...
        .then(function (data) {
            ...
            fetch('http://api.openweathermap.org/data/2.5/uvi?lat=' + data.coord.lat + '&lon=' + data.coord.lon + '&units=imperial&appid=80537c5878d1c4c5e4b0fb4912dedc85')

                .then(function (responseUv) {
                    return responseUv.json();
                })

                .then(function (dateUv) {
                    var uvPlease = dateUv.value;
                    console.log(uvPlease);
                    ...
                    function add() {
                        ...
                        element.setAttribute('value', cityList),
               ...
               // FIVE DAY 
                    ...
                    $('#card2date').innerHTML = "<h5>" + date.daily[3].dt + "</h5>"
                    $('#card2-text').innerHTML = "<p> : " + data.daily [3].humidity + "</br> Temp : " + data.daily [1].temp.day + " F </p>"

                    $('#card2date').innerHTML = "<h5>" + date.daily[4].dt + "</h5>"
                    $('#card2-text').innerHTML = "<p> : " + data.daily [4].humidity + "</br> Temp : " + data.daily [1].temp.day + " F </p>"

                    $('#card2date').innerHTML = "<h5>" + date.daily[5].dt + "</h5>"
                    $('#card2-text').innerHTML = "<p> : " + data.daily [5].humidity + "</br> Temp : " + data.daily [1].temp.day + " F </p>"
