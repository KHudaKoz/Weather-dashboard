...
var citySearch = document.quertySelector('#citySearch').value;

fetch (
    'http://api.openweathermap.org/data/2.5/weather?q=' + citySearch + 'sorlando&appid=80537c5878d1c4c5e4b0fb4912dedc85'
