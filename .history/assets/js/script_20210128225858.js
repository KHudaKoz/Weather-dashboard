...
memory = JSON.parse(localStorage.getItem("cities")) || [];
//SET VAR MY CITY RETRIEVE
var memoryLoad = function () {JSON.parse(localStorage.getItem('cityHistory'))
 if(memoryLoad !=null){
     for (let i = 0; i < loadMemory.length; i++) {
     cityHistory.push(loadMemory [i])
     }
