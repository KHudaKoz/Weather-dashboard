        ...
        .then(function (data) {
            ...
            fetch('http://api.openweathermap.org/data/2.5/onecall?lat=' + data.coord.lat + '&lon=' + data.coord.lon + '&units=imperial&appid=80537c5878d1c4c5e4b0fb4912dedc85')
                ...
                .then(function (data1) {
                    ...
                    var symbols = $('<img>').attr("src", "https://openweathermap.org/img/wn/" + data1.weather[0].icon + ".png")
                    var tempEL = $("<p>").text("Tempature : " + data.main.temp + "&deg");
                    ...
                    var newDiv = $('<div>');
                    newDiv.append(dateDisplay, sytempEL, humEl, windEl, UvEl);
